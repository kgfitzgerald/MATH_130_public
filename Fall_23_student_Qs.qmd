...
**Q: Is there another time there will be lab help with our LA?**

**A:** For Lab 02, the times to get help are:

-   Wednesday 9/27, in-class help session with Joseph

-   Monday 10/2, in-class help session after group quiz is turned in

-   Monday 10/2, 4:15 - 5:30 student hours

-   Tuesday 10/3, 2:30 - 4pm student hours

-   Thursday 10/5, 10 - 11:30 student hours

-   Monday - Thursday, 3 - 7pm, Tutoring Center

-   Anytime: post questions to Campuswire

**Q: Can you go over some of the homework questions?**

-   We generally won't spend class-time on the homework, BUT, you can post a specific question on Campuswire, and we can discuss there and/or utilize any of the above times mentioned for lab help to get in-person help / clarification on the homework as well

### Week 3

**Q: How do I get tutoring? Every time I look it says there is none**

-   Thanks for bringing this to my attention! I followed up with the Tutoring Center and their hours are now available on the website.

-   Drop-in hours are from 4 - 7pm, Monday - Thursday

**Q: Will groups always be the same for quizzes?**

-   Nope, they will change for each quiz

**Q: Where will the help sessions be held?**

-   TBD, but mostly likely a classroom in Segerstrom
...
**Q: Can student hours be on Zoom?**

-   Yes! The Monday & Tuesday student hours both have a Zoom option (in addition to the in-person option at Segerstrom 112). See Canvas for the Zoom link.
...
**Q: Is a normal distribution used to describe modality or skew, or perhaps does it describe both?**

-   A normal distribution is unimodal and symmetric - so it incorporates both! We'll learn a lot more about the normal distribution in future chapters :)

**Q: I sometimes mix up stacked bar plots and standardized bar plots and sometimes wonder how to differentiate between them?**

-   I often get the terminology mixed up too! But the important things to know are that they're both for 2 categorical variables, and one (the stacked bar plot) shows counts on the y-axis (which means the bars might be different heights), and the other (standardized bar plot) shows proportions on the y-axis (which means the bars will be the same height - of 1.0).
...
-   Will have a different (randomized) group each time - see Canvas for next group assignments

-   What type of variable(s) is a histogram good for?

-   With patients who entered the ER as the observational units, the following ARE variables:

    -   how long the patient waits

    -   whether or not the patient has health insurance

    -   day of the week the patient arrives

    -   cost of the ER visit

-   With patients who entered the ER as the observational units, the following are NOT variables:

    -   Average wait time for a patient

    -   Whether or not wait times tend to be longer on weekends than weekdays

-   With Super Bowls as observational units, the following ARE good examples of variables:

    -   How long the game was

    -   Were there any injuries?

    -   How much $ the game produced

    -   Winning team

    -   How many points winning team scored

    -   Whether or not the winning team made any field goals

    -   Total points scored in the game by touchdowns

-   With Super Bowls as observational units, the following are NOT variables:

    -   \# of games played

    -   Do you have good team work?

    -   Number of games that were won

    -   Whether or not they won or lost

# Group Quiz 2 Debrief

*Suppose that the average (mean) house price in a community is $425,000. Do you suspect that more than 50%, less than 50%, or exactly 50% of the houses cost more than the average (mean)?*

-   Key is to realize 50th percentile is the median, so you need to discern if the mean is farther to the left, farther to the right, or the same as the median.

-   House prices are right-skewed, so the mean is larger than (farther to the right than) the median. This means that *less than 50%* will be greater than the mean.
